...
public class mpu1_importer : AssetPostprocessor {
	private static readonly string filePath = "Assets/mpu1.xls";
	private static readonly string exportPath = "Assets/Resources/mpu1.asset";
