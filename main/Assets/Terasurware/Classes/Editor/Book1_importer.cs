...
public class Book1_importer : AssetPostprocessor {
	private static readonly string filePath = "Assets/Book1.xls";
	private static readonly string exportPath = "Assets/Resources/Book1.asset";
